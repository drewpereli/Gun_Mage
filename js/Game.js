...
function Game(){
	...
	this.DEBUG = {
		...
		playerStartingWeapon: new Pistol(), //If false, the player doesn't start with a weapon. Else, the player starts with the weapon object contained here.
		...
		numberOfEnemies: 1, //sets the number of enemies that will spawn
