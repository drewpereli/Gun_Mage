...
GlobalVariables.prototype.initialize = function()
{
	...
	*/
	this.colors = {
		WALL: this.COLORCONSTANTS.LIGHTGRAY,
		OPEN: this.COLORCONSTANTS.DARKGRAY,
		...
		border: this.COLORCONSTANTS.GRAY,
